              ...
              <div class="row align-items-center">
                ...
                <?php
                  ...
                  if($resChe > 0){
                    while($row = mysqli_fetch_assoc($res)){
                      echo '
                  <label>Fiche du patient: n° Dossier '.$row["dossier"].' <label>';
                  }
                }
                ?>
                </div>
                <div class="col text-right">
                  ...
                  <a role="button" data-toggle="tooltip" data-placement="top" title="Archiver le patient" class="btn btn-sm btn-danger" href="archiver.php?id='.$dd.'">
                ...
                <div class="col-8">
                  <div class="row">
                    ...
                    <div class="form-group col-lg-3">
                      ...
                      echo '
                     <input type="text" class="form-control" id="exampleFormControlInput40" name="age" value="'.$age->format('%y ans %m mois').'" readonly>
                    </div>
                    <div class="form-group col-lg-3">
