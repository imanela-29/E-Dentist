                ...
                <div class="card-body">     
                  <div class="row">
                    <div class="col-4 text-center">
                      <img src="photo_employe/'.$row["img"].'" alt="Photo de profil" class="img-fluid" style="width: 150px;">
                    </div>
                    <div class="col-8">
                      <div class="row">
...
<?php
  ...
  if( isset($_POST["ajout"]) ){
    ...
    $que = "SELECT * FROM employe WHERE id = '$dd'";
    ...
    $q = "UPDATE employe SET img = '$image' WHERE id = '$dd' ";
    $conn->query($q);
