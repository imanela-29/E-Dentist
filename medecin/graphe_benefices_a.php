...
if(!isset($_SESSION["email"])){
  ...
  include 'php/conn.php';
   ...
   $stmt = "SELECT month(dated) as m, SUM(prix) as total FROM benefice WHERE ( dated >= DATE_FORMAT(NOW() ,'%Y-01-01') ) GROUP BY m";
...
<head>
  ...
  <title>Graphe bénefices /an| Cabinet docteur</title>
  <!-- Favicon -->
  ...
  <script type="text/javascript">
    ...
    var config2 = {
      ...
      options: {
        ...
        title: {
          display: true,
          text: 'Graphe Bénefices par mois'
        },
        tooltips: {
          mode: 'index',
          intersect: false,
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Bénefices <span style="font-size: 10px">par mois</span></h3>
                </div>
              </div>
            </div>
                        ...
                        while($row1 = mysqli_fetch_assoc($res1)){
                          echo '
                            <tr class="text-center">
                              ...
                              <td class="text-info">'.$row1["total"].'</td>
                            </tr>';  
                        }
                      }
                ?>
...
$(document).ready(
    function(){
      setInterval(function(){
        $("#refresh_ben").load("refresh_ben.php");
      },1000);
    });
</script>
