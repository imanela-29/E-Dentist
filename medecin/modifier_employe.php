...
<head>
  ...
  <title>
    <?php
      $qu = "SELECT * FROM employe WHERE id = $dd";
      $res = mysqli_query($conn,$qu);
      $resChe = mysqli_num_rows($res);
      if($resChe > 0){
        while($row = mysqli_fetch_assoc($res)){
          echo 
            $row["nom"]. ' | Cabinet Docteur'
          ;
        }
      }
    ?>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a role="button" data-toggle="tooltip" data-placement="top" title="Ajouter Photo" class="btn btn-icon btn-sm btn-outline-info" href="ajout_photo_employe.php?id='.$row['id'].'">
                        ...
                        while($row = mysqli_fetch_assoc($res)){
                          ...
                          <div class="row">
                            <div class="form-group col-xl-6">
                              <label for="exampleFormControlInput70">Paiement</label>
                              <input type="number" class="form-control" id="exampleFormControlInput70" value="'.$row["prix"].'" name="prix">
                            </div>
                            <div class="form-group col-xl-6">
                              <label for="exampleFormControlInput700">Poste</label>
                              <input type="text" class="form-control" id="exampleFormControlInput700" value="'.$row["poste"].'" name="poste">
                            </div>
                          </div>                         
                          ';
                        }
...
<?php
  ...
  if( isset($_POST["submit"]) ){
    ...
    $a = "UPDATE employe SET nom = '$nom', email = '$email', CB = '$cb', cin = '$cin', adresse = '$adresse', tel = '$tel', poste = '$poste', prix = '$prix' WHERE id = '$dd' ";
    $conn->query($a);
