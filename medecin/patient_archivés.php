...
<head>
  ...
  <title>Patients Archivés | Cabinet docteur</title>
  <!-- Favicon -->
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Liste des patients archivés</h3>
                </div>
              </div>
                          ...
                          while($row = mysqli_fetch_assoc($res)){
                            ...
                            if( $row["nom"] == '' || $row["cin"] == '' || $row["tel"] == '' || $row["adresse"] == '' || $row["fonction"] == '' || $row["date_naissance"] == '' || $row["mutuelle"] == '' || $row["genre"] == '' || $row["dossier"] == '' || $row["maladies"] == '' || $row["chirurgie"] == '' || $row["medicaments"] == ''  ){
                             ...
                             echo' <td>'.$row["dossier"].'</td>
                              ...
                              <td>
                                <a role="button" data-toggle="tooltip" data-placement="top" title="Fiche du patient" class="btn btn-sm btn-outline-info" href="fiche_patient_archiv.php?id='.$row['id'].'">
                                  <i class="fas fa-eye"></i>
                                </a>
                                <a role="button" data-toggle="tooltip" data-placement="top" title="Désarchiver le patient" class="btn btn-sm btn-success" href="desarchiver.php?id='.$row["id"].'">
                                  <i class="fas fa-archive"></i> 
                                </a>
                              </td>
                            </tr>
