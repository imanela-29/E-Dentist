          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Liste des RDV</h3>
                </div>
                <div class="col text-right">
                  <a href="lrdv2.php" class="btn btn-sm btn-vimeo">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Liste salle d'attente</h3>
                </div>
                <div class="col text-right">
                  <a href="salle_attente.php" class="btn btn-sm btn-dribbble ">Voir plus</a>
                </div>
              </div>
            </div>
          </div>
