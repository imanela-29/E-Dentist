...
<?php
  ...
  if( isset($_POST["ajout"]) ){
    ...
    $que = "SELECT * FROM patient WHERE id = $dd";
    ...
    $target = "repertoire/".$row["cin"]."/".basename($image);

     }
    }

    $q = "UPDATE patient SET img = '$image' WHERE id = '$dd' ";
    $conn->query($q);
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-lg-6">
                      <input type="file" class="form-control" id="exampleFormControlInput10" accept="image/*" name="image" required>
                    </div>
                    <div class="form-group col-lg-6">
